...
about_me = """
Я инженер-робототехник с научными интересами в области манипуляции роботами, восприятия и робототехники, ориентированной на человека. Сейчас я учусь в магистратуре по робототехнике в Университете Миннесоты.  
Моё образование и опыт вы можете увидеть в хронологии ниже, а также мои публикации и доклады.
"""
################
# TOP PROJECTS #
################
...
color = "#fff"
description = """
Создан конвейер для автоматизированного тактильного исследования силиконового конуса с помощью коллаборативного манипулятора UR5.
"""
...
color = "#fff"
description = """
Запрограммирован робот UR5 через Python API RoboDK для автономной сборки фонарика без участия человека.
"""
...
color = "#fff"
description = """
Разработан конвейер избегания препятствий на базе LiDAR для TurtleBot3 Burger и интегрирована камера Raspberry Pi для отслеживания маркеров ArUco.
"""
...
color = "#fff"
description = """
Спроектирован и создан 5-DOF гибридный роботизированный плечевой экзоскелет, обеспечивающий полный диапазон вращения плеча.
"""
...
color = "#fff"
description = """
Разработан 5-DOF миниатюрный механизм, сочетающий в себе кинематические механизмы для имитации плечевого сустава.
"""
...
foreground = "#7a0019"
content = """
Изучаю основы машинного обучения, робототехнику, компьютерное зрение и системы интеллектуальной робототехники в рамках [стипендии Болашак](https://bolashak.gov.kz/ru/o-kompanii).
"""
